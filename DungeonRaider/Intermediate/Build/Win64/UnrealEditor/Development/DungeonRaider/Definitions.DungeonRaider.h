...
#define UE_PROJECT_NAME DungeonRaider
#define UE_TARGET_NAME DungeonRaiderEditor
#define UE_MODULE_NAME "DungeonRaider"
...
#define DUNGEONRAIDER_API DLLEXPORT
