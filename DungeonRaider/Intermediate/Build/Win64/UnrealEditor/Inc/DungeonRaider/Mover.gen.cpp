...
#include "DungeonRaider/Mover.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMover() {}
// Cross Module References
	DUNGEONRAIDER_API UClass* Z_Construct_UClass_UMover_NoRegister();
	DUNGEONRAIDER_API UClass* Z_Construct_UClass_UMover();
...
// End Cross Module References
	...
	template<> DUNGEONRAIDER_API UClass* StaticClass<UMover>()
	{
		return UMover::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UMover);
	struct Z_CompiledInDeferFile_FID_DungeonRaider_Source_DungeonRaider_Mover_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_DungeonRaider_Source_DungeonRaider_Mover_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMover, UMover::StaticClass, TEXT("UMover"), &Z_Registration_Info_UClass_UMover, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMover), 1636618340U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_DungeonRaider_Source_DungeonRaider_Mover_h_1934146279(TEXT("/Script/DungeonRaider"),
		Z_CompiledInDeferFile_FID_DungeonRaider_Source_DungeonRaider_Mover_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_DungeonRaider_Source_DungeonRaider_Mover_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
